...
<section class="section">
    <div class="section-header">
        <h3 class="page__heading">Computadores</h3>
    </div>
                                    ...
                                    <div class="modal-body">
                                        <form id="frmEstados" method="POST" action="{{url("computadores")}}">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" name="ID_Portatilesp" class="form-control"
                                                    maxlength="50" placeholder="ID" required>
                                            </div>
                                            <div class="input-group mb-3">
                                                <span class="input-group-text"><i class="fa-solid fa-tag"></i></span>
                                                <input type="text" name="Tag" class="form-control" maxlength="50"
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="number" name="Inventario" class="form-control"
                                                    maxlength="50" placeholder="Inventario" required>
                                            </div>
                                            <div class="input-group mb-3">
                                                <span class="input-group-text"><i class="fa-solid fa-laptop"></i></span>
                                                <input type="text" name="Especificaciones" class="form-control"
                                                    maxlength="50" placeholder="Especificaciones" required>
                                            </div>
                                            <div class="input-group mb-3">
                                                <span class="input-group-text"><i
                                                        class="fa-solid fa-graduation-cap"></i></span>
                                                <input type="text" name="Carrera" class="form-control" maxlength="50"
                                            ...
                                            <div class="d-grid col-6 mx-auto">
                                                <button class="btn btn-success"><i class="fa-solid fa-floppy-disk>"></i>
                                                    Guardar</button>
                                            </div>
                                        </form>
                                    </div>
